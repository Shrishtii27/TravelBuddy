...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(`👋 Welcome back, ${user.firstName}! Ready for your next adventure?`, {
        duration: 5000,
        icon: '🌍',
        style: {
          borderRadius: '10px',
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-500 via-orange-400 to-pink-500 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-white/80 font-medium">Sign in to manage your trips and itineraries</p>
        </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <a href="#" className="text-sm text-rose-600 hover:text-rose-700 font-semibold transition-colors">Forgot?</a>
                  </div>
                  <Input
                    id="password"
                    name="password"
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-xl shadow-lg shadow-rose-200 transition-all hover:scale-[1.02] active:scale-[0.98]"
                  disabled={loading}
                >
                  {loading ? (
        ...
        >
          ...
          <Link to="/signup" className="text-yellow-200 font-bold hover:text-white transition-colors underline underline-offset-4 decoration-2">
            Create one
          </Link>
        </motion.p>
      </div>
