    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-500 via-orange-400 to-pink-500 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-15">
        <motion.img
          ...
          className="absolute top-20 left-10 w-40 h-40 rounded-2xl object-cover shadow-2xl"
          animate={{ y: [0, -20, 0] }}
          transition={{ duration: 8, repeat: Infinity, repeatType: "reverse" }}
        />
        <motion.img
          src="https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=250&q=80"
          alt="travel decoration"
          className="absolute bottom-20 right-10 w-36 h-36 rounded-2xl object-cover shadow-2xl"
          animate={{ y: [0, 20, 0] }}
        ...
        <motion.img
          ...
          alt="travel decoration"
          className="absolute top-1/3 right-20 w-32 h-32 rounded-2xl object-cover shadow-2xl"
          animate={{ y: [0, -15, 0] }}
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-white/90 text-lg">Sign in to continue your adventure</p>
        </motion.div>
        ...
        >
          <Card className="shadow-2xl border-0 backdrop-blur-sm bg-white/95">
            <CardHeader className="space-y-1 pb-6">
              <CardTitle className="text-center text-2xl font-bold text-slate-900">Sign In</CardTitle>
              <p className="text-center text-slate-600 text-sm">Enter your credentials to access your account</p>
            </CardHeader>
            <CardContent>
              {error && (
                <motion.div 
        ...
        >
          <p className="text-white text-base">
            ...
            <Link to="/signup" className="text-yellow-200 hover:text-yellow-100 font-bold underline">
              Sign up for free
            </Link>
          </p>
        </motion.div>
